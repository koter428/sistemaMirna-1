...
(cod_ajuste_stock, tipo_ajuste, fecha_ajuste,  cod_usuario, id_sucursal)
VALUES(:cod_ajuste_stock, :tipo_ajuste, 
:fecha_ajuste, ".$_SESSION['id_user'].", :id_sucursal);");
...
cod_ajuste_stock 
from ajuste_stock  
order by cod_ajuste_stock desc limit 1");
