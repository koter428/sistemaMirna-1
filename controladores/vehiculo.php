...
function leer_activo(){
    $base_datos = new DB();
    $query = $base_datos->conectar()->prepare("SELECT cod_vehi, marca, modelo, ao,
        chapa, tipo_vehiculo, capacidad_carga, estado, fecha_registro,
        kilometraje, fecha_prox_mantenim
FROM vehiculo
WHERE estado = 'ACTIVO'");
