...
(cod_pedido_compra, fecha_pedido, estado, cod_usuario, cod_sucursal)
VALUES(:cod_pedido_compra, :fecha_pedido, :estado, ".$_SESSION['cod_usuario'].", :cod_sucursal);");
...
order by pc.cod_pedido_compra desc
...
function actualizar($lista){
    ...
    $query->execute([
        'fecha_pedido' => $json_datos['fecha_pedido'],
        'estado' => $json_datos['estado'],
        'cod_pedido_compra' => $json_datos['cod_pedido_compra']
    ]);
}
